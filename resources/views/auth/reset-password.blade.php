...
<head>
    ...
    <title>FlowZone — Nueva contraseña</title>
    ...
    <style>
        ...
        .auth-field-wrap .toggle-pass { position: absolute; right: .9rem; top: 50%; transform: translateY(-50%); color: var(--gray-400); font-size: .85rem; cursor: pointer; background: none; border: none; padding: 0; }
        .auth-field-wrap .toggle-pass:hover { color: var(--green-700); }
        .auth-field input { width: 100%; padding: .8rem 2.5rem .8rem 2.5rem; background: var(--white); border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); font-family: var(--font-body); font-size: .92rem; color: var(--gray-900); transition: border-color .2s, box-shadow .2s; outline: none; box-sizing: border-box; }
        ...
        .password-strength { margin-top: .5rem; display: flex; align-items: center; gap: .5rem; }
        .strength-bars { display: flex; gap: 3px; flex: 1; }
        .strength-bar { flex: 1; height: 3px; border-radius: 2px; background: var(--gray-200); transition: background .3s; }
        .strength-label { font-size: .72rem; color: var(--gray-400); white-space: nowrap; }
...
<div class="auth-panel-right">
    <div class="auth-heading">
        <div class="auth-eyebrow">Casi listo</div>
        <h2>Crea tu nueva<br><em>contraseña</em></h2>
    </div>
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="auth-field">
            <label for="campo-password">Nueva contraseña</label>
            <div class="auth-field-wrap">
                ...
                <button type="button" class="toggle-pass" onclick="toggleVer('campo-password', this)">
            ...
            <div class="password-strength" id="strength-wrap" style="display:none;">
                ...
                <span class="strength-label" id="strength-label">Muy débil</span>
            </div>
        </div>

        <div class="auth-field">
            <label for="campo-password-confirm">Confirmar contraseña</label>
            <div class="auth-field-wrap">
                <i class="auth-icon fa-solid fa-lock"></i>
                <input type="password" name="password_confirmation" id="campo-password-confirm"
                       required autocomplete="new-password" placeholder="Repite la contraseña">
                <button type="button" class="toggle-pass" onclick="toggleVer('campo-password-confirm', this)">
                    <i class="fa-solid fa-eye"></i>
                </button>
            </div>
        </div>
        ...
        <button type="submit" class="auth-submit">
            <i class="fa-solid fa-shield-halved"></i> Guardar nueva contraseña
        </button>
    </form>
